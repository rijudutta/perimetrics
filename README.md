...
Check out [tests](/tests) for a test of our code on a circular contour, and how the accuracy of perimeter estimation depends on the size (in pixels) of the circle, and on the gradient of the intensity at the edge of the circle.
